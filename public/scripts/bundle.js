...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = (function (_super) {
	    ...
	    // スクロールイベント
	    CommentBox.prototype.onScroll = function (targetId) {
	        var target = $("#" + targetId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = (function (_super) {
	    ...
	    CommentForm.prototype.render = function () {
	        return (React.createElement("div", {className: "row"}, React.createElement("form", {className: "commentForm", onSubmit: this.submit.bind(this), style: { backgroundColor: 'white', bottom: 0, width: '100%', position: 'fixed' }}, React.createElement("input", {type: "text", placeholder: "Your name", value: this.state.author, onChange: this.handleAuthorChange, style: { marginBottom: 0 }, hidden: true}), React.createElement("div", {style: { width: '65%', display: 'block', float: 'left' }}, React.createElement("input", {type: "text", placeholder: "メッセージを入力...", value: this.state.text, onChange: this.handleTextChange, style: { width: '100%', marginBottom: 0 }}), React.createElement("button", {type: "submit", onClick: this.handleSubmit, className: 'btn waves-effect waves-light', style: { display: 'none' }}, "Submit", React.createElement("i", {className: "material-icons right"}, "send"))), React.createElement("div", {style: { width: '35%', display: 'block', float: 'left' }}, React.createElement("ul", {style: { margin: 0 }}, React.createElement("li", {st: true}, React.createElement("img", {src: "./img/pin.png", style: { marginTop: '8px' }})))))));
	    };
	    return CommentForm;
	}(React.Component));
	...
	var CommentList = (function (_super) {
	    ...
	    CommentList.prototype.render = function () {
	        var commentNodes = this.props.data.map(function (comment) {
	            ...
	            return (React.createElement(Comment_1.Comment, {author: comment.author, key: comment.id, position: css, color: color, fontColor: font_color, img: comment.img}, comment.text));
	        });
	        //{配列}は展開される
	        return (React.createElement("div", {className: "commentList", style: { overflowY: 'scroll', height: '80vh', paddingTop: '40px', paddingRight: '30px', paddingLeft: '13px' }}, commentNodes));
	    };
	    return CommentList;
	}(React.Component));
