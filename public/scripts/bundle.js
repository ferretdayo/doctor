...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chat = (function (_super) {
	    ...
	    Chat.prototype.handleCommentSubmit = function (comment) {
	        //今のコメントリストの情報を取得
	    ...
	    //ユーザ情報の取得
	    Chat.prototype.loadUsersFromServer = function () {
	        $.ajax({
	            url: "/api/userlist",
	            dataType: 'json',
	            cache: false,
